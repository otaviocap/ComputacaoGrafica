...
bool rotateX = true, rotateY = true, rotateZ = false;
...
int main() {
    ...
    //
    model = glm::rotate(model, /*(GLfloat)glfwGetTime()*/ glm::radians(90.0f),
...
// Esta função está basntante hardcoded - objetivo é compilar e "buildar" um
// programa de
